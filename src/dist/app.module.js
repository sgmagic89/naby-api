    ...
    AppModule = __decorate([
        common_1.Module({
            imports: [
                ...
                mongoose_1.MongooseModule.forRoot('mongodb+srv://sgmagic:My_Mongo_89@cluster0.gtjqwjc.mongodb.net/?retryWrites=true&w=majority', {}),
                    ...
                    useFactory: function (config) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, ({
                                    ...
                                    dbName: config.get('mongodb.database.databaseName')
                                })];
                        });
                    }); }
                }),
                ...
                axios_1.HttpModule.registerAsync({
                    ...
                    useFactory: function (configService) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, ({
                                    baseURL: configService.get('api.apiUrl'),
                                    timeout: configService.get('api.httpTimeout')
                                })];
                        });
                    }); },
                    inject: [config_1.ConfigService]
